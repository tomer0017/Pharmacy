<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateClient.aspx.cs" Inherits="Pharmacy.UpdateClient" %>
<!doctype html>
<html lang="en">
							...
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item ">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PharmacyConnectionString %>" SelectCommand="SELECT [Cid] FROM [Client]"></asp:SqlDataSource>
                                        </a>
									&nbsp;</li>
									...
									<li class="nav-item submenu dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a class="nav-link" href="services.html">עידכון עובד</a>
											</li>
											<li class="nav-item">
                               ...
                               <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-9">
                                                ...
                                                <asp:DropDownList ID="DropDownList3" AppendDataBoundItems="true"  AutoPostBack="true" runat="server" DataSourceID="SqlDataSource1" DataTextField="Cid" DataValueField="Cid" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <asp:Button ID="Button2" class="btn btn-primary" runat="server" OnClick="Button2_Click" Text="עדכן לקוח" />
