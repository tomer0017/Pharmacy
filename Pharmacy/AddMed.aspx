<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMed.aspx.cs" Inherits="Pharmacy.AddMed" %>
<!doctype html>
<html lang="en">
						...
						<div class="row ml-0 w-100">
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item ">
										<a class="nav-link" href="Reports.aspx">דוחות</a>
									</li>
                            ...
                            <div class="card card-outline-secondary">
                                <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 col-form-label form-control-label"><asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TextBox1" ErrorMessage="הכנס שם תרופה" ForeColor="Red">*</asp:RequiredFieldValidator>שם תרופה </label>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <label class="col-md-3 col-form-label form-control-label"> <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox2" ErrorMessage="הכנס סוג תרופה" ForeColor="Red">*</asp:RequiredFieldValidator>סוג תרופה</label>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <label class="col-md-3 col-form-label form-control-label"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="הכנס מחיר" ForeColor="Red">*</asp:RequiredFieldValidator>מחיר</label>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <div class="col-md-9">
                                                <asp:TextBox ID="TextBox8" class="form-control" runat="server" value="" ></asp:TextBox> 
                                            </div>
                                            <label class="col-md-3 col-form-label form-control-label"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox8" ErrorMessage="הכנס כמות" ForeColor="Red">*</asp:RequiredFieldValidator>כמות</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 col-form-label form-control-label"><asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="TextBox7" ErrorMessage="הכנס סיווג" ForeColor="Red">*</asp:RequiredFieldValidator>סיווג</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <a class="btn btn-secondary" href="AddMed.aspx">נקה</a>
                                                <asp:Button ID="Button2" class="btn btn-primary" runat="server" OnClick="Button2_Click" Text="הוסף תרופה" />
