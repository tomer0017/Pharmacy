<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R2.aspx.cs" Inherits="Pharmacy.R2" %>
                        ...
                        <h1>דוח מלאי תרופות</h1>
						 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="auto-style1" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display.">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="שם תרופה" SortExpression="Name" />
                                    <asp:BoundField DataField="Barcode" HeaderText="ברקוד" SortExpression="Barcode" />
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"></asp:SqlDataSource>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PharmacyConnectionString %>" ProviderName="<%$ ConnectionStrings:PharmacyConnectionString.ProviderName %>" SelectCommand="SELECT [Barcode], [Name], [Quantity] FROM [Medicine]"></asp:SqlDataSource>
                        </div>
