<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMed.aspx.cs" Inherits="Pharmacy.UpdateMed" %>
<!doctype html>
<html lang="en">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <label class="col-md-3 col-form-label form-control-label"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox1" ErrorMessage="הכנס כמות" ForeColor="Red">*</asp:RequiredFieldValidator>כמות</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <asp:Button ID="Button2" class="btn btn-primary" runat="server" OnClick="Button2_Click" Text="עדכן תרופה" />
