<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorker.aspx.cs" Inherits="Pharmacy.AddWorker" %>
<!doctype html>
<html lang="en">
...
<body>
	...
	<!--================ Home Banner Area =================-->
	<section style="align-content:center" class="home_banner_area" >
       ...
       <div class="row">
                        <div class="col-md-6 my-3">
                            <div class="card card-outline-secondary">
                                <div class="card">
                                     <h1  style="margin-bottom:20px; text-align:center;color:black;">הוספת עובד</h1>
