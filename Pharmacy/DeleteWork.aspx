<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteWork.aspx.cs" Inherits="Pharmacy.DeleteWork" %>
<!doctype html>
<html lang="en">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <asp:Button ID="Button2" class="btn btn-primary" runat="server" OnClick="Button2_Click" Text="הסר עובד" />
